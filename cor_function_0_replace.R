...
##the most time-consuming process of prepring V9 barcde data is done out of cycle, to save time. Can also be run in cycle, but takes a while
...
#dataV9_meltedX[,value3:=compositions::alr(value3),by=variable]
...
for(i in list_of_all[1:(length(list_of_all))]) {
  ...
  #Centred log-ratio transformation of SMAG abundances

  
  #dataSMAGs[,value2:=value+1]
  #dataSMAGs[,value2:=compositions::alr(value2),by=variable]
